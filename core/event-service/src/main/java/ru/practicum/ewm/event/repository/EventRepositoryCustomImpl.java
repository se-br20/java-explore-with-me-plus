...
public class EventRepositoryCustomImpl implements EventRepositoryCustom {
    ...
    public List<EventShortDto> findEventsShortDto(
        ...
        BooleanBuilder predicate =
                createPredicate(param);

        return queryFactory
                .select(
                        createEventShortProjection()
                )
                .from(event)
                .where(predicate)
    ...
    @Override
    public Optional<EventFullDto>
    findEventByIdFullDto(
            Long id
    ) {
        EventFullDto result =
                queryFactory
                        .select(
                                createEventFullProjection()
                        )
                        .from(event)
    ...
    private com.querydsl.core.types
            .ConstructorExpression<EventShortDto>
    createEventShortProjection() {
    ...
    private com.querydsl.core.types
            .ConstructorExpression<EventFullDto>
    createEventFullProjection() {
        return Projections.constructor(
                EventFullDto.class,
                event.id,
